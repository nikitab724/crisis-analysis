...
- Mac CSV history remains temporary across pipeline restarts. This setup does not make the model run on Render or provide independent, always-on processing.
